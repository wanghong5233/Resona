...
| 阶段 | 时间 | 模型后端 | 可演示性 | 面试竞争力 |
|------|------|----------|----------|----------|
| **Week 1** | Day 1-9 | GPT-4 API | ✅ Web 原型 | ⭐⭐⭐ 架构设计 |
| **Week 2-3** | Day 10-20 | GPT-4 / Qwen | ✅✅ Desktop 应用 | ⭐⭐⭐⭐ 工程能力 |
| **Week 4-5** | Day 21-35 | 自训练模型 | ✅✅✅ 专业级 | ⭐⭐⭐⭐⭐ 技术深度 |

详见：[Project_Design.md](./Project_Design.md)
...
- 🎉 项目初始化
- ✅ 创建项目目录结构
- ✅ 配置开发环境（Docker + Makefile）

---

**我们相信：在 AI 的加持下，每个人都能成为"高情商"的自己。**  
**Resona，让沟通回归真诚，让表达更有温度。**
